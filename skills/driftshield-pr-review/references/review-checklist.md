...
- Prefer bugs, regressions, and missing verification over style commentary.
...
- Full-stack change:
  Run targeted backend tests, frontend build/lint, and a browser flow covering the changed UX.
